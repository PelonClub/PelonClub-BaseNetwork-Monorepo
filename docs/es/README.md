...
- **[PelonStakingVault Contract](pelon-staking-vault.md)** - Análisis técnico exhaustivo del contrato inteligente de vault de staking. Incluye cumplimiento del estándar ERC4626, implementación del sistema de timelock FIFO configurable (1-90 días, por defecto 15 días), mecanismo de tarifas de retiro configurable (0-10%, por defecto 3%) con distribución 50/25/25, mecanismo de re-staking que aumenta el valor por share, rastreo y gestión de depósitos con FIFO optimizado basado en índices, funciones preview mostrando montos netos después de tarifas, consideraciones de seguridad y optimizaciones de gas, y diagramas Mermaid de flujos y transiciones de estado.

- **[Guía de Usuario del Vault de Staking](guia-usuario-vault-staking.md)** - Guía de usuario completa para inversionistas que explica cómo usar el PelonStakingVault. Incluye introducción a vaults ERC4626, explicación detallada de la mecánica del vault y cálculo de shares, guía completa del sistema de timelock FIFO configurable (1-90 días, por defecto 15 días), explicación del sistema de tarifas de retiro con distribución 50/25/25 (configurable 0-10%, por defecto 3%), beneficios del re-staking que aumentan el valor por share, operaciones paso a paso del usuario (depósitos, retiros, canjes), funciones preview mostrando montos netos después de tarifas, casos de uso prácticos con ejemplos del mundo real y cálculos, preguntas frecuentes, consideraciones técnicas (costos de gas, mejores prácticas, seguridad), y diagramas Mermaid de flujos de depósito, procesos de retiro y transiciones de estado FIFO.
...
- **[Análisis de Seguridad PelonStakingVault](analisis-seguridad-pelon-staking-vault.md)** - Análisis técnico exhaustivo incluyendo hallazgos de Slither, cobertura comprehensiva de tests (75 tests), características de seguridad, mejores prácticas, y mecanismos innovadores. Incluye análisis completo de resultados de Slither, análisis de suite de tests (75 tests, 100% tasa de aprobación), características de seguridad y mecanismos (protección reentrancy, timelock FIFO, distribución de tarifas), mejores prácticas y convenciones (uso de OpenZeppelin, cumplimiento ERC4626, optimización de gas), características innovadoras (FIFO basado en índices, re-staking no dilutivo, distribución de tarifas en tres vías), diagramas Mermaid (arquitectura, flujos, transiciones de estado), métricas y estadísticas (análisis de gas, cobertura de tests, métricas de seguridad), y guías y recomendaciones para auditores, desarrolladores y usuarios.
...
**Testing PelonStakingVault**: El contrato PelonStakingVault tiene **75 tests comprehensivos** con 100% de tasa de aprobación. El análisis detallado de tests está incluido en la documentación de [Análisis de Seguridad PelonStakingVault](analisis-seguridad-pelon-staking-vault.md).
