...
flowchart TD
    ...
    D --> D1[Founding Team: 15% - 150B]
    D --> D2[Advisors: 5% - 50B]
    
    E --> E1[Marketing Campaigns: 6% - 60B]
    E --> E2[Partnerships: 2% - 20B]
    E --> E3[Influencers & KOLs: 2% - 20B]
    
    F --> F1[Operations: 3% - 30B]
    F --> F2[Emergency Fund: 2% - 20B]
    ...
    style E fill:#c7d2fe,stroke:#000,stroke-width:2px,color:#000
    style F fill:#e0e7ff,stroke:#000,stroke-width:2px,color:#000
    style G fill:#eef2ff,stroke:#000,stroke-width:2px,color:#000
```
