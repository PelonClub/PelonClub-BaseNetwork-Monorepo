...
export const PELON_CLUB_TOKEN_ABI = [
  {
...
export const PELON_CLUB_TOKEN_ADDRESS = (process.env
  .NEXT_PUBLIC_PELON_TOKEN_ADDRESS || '0x734AE77B7dE9B5cc3Ce9d3D20B92c769d8588f15') as Address;
